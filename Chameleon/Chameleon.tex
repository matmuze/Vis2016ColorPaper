...
%	
	...
	We therefore keep the chroma and luminance constant and distinguish the proteins by hue only. 
	...
	With constant chroma and luminance, hues are selected from an iso-luminant hue ring with uniform chroma. 
	...
	We found that a luminance of 75 [tbd wasn't this because max chroma?]represents a good value, leading to a maximum chroma of 40 (see Figure \ref{fig:hslvshcl}). 
...
%	In the example of Figure \ref{fig:zoomLevels}, we use a luminance range of 20 to distinguish the sub-elements. 
	...
	To answer these two research questions, we asked seven students and professionals in the field of biology to perform two tasks. 
	...
	The task description was provided by the molecular biologist and illustrator David Goodsell and resembles publicly available description of the HIV capsid at PDB-101 \cite{goodsell2016} (see supplemental material for full task description).
	Based on this description of the HIV capsid, users were asked to identify the following structures: 
	\begin{enumerate}
		\itemsep0em 
		\item one of the 12 pentamer capsid protein, 
	...
	To assess the performance in the structure identification task, we recorded whether users were able to correctly identify the above listed structures solely based on their structural representation. 
	We provided no textual labels or details-on-demand in this study.  
	...
	\definecolor{cn}{rgb}{0.5,0.5,0.5}
	 ...
	 All those users referred to the domains by color. 
	 Several (\textbf{TODO: how many??}) also referred to the alpha helices by color. 
	 
	 \begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{Figures/questionnaires.pdf}
\caption{Average and standard error responses on five-point Likert scale for questions concerning the ease of identification of structures.}
...
TODO: color questionnaire, atomic level
...
Our results indicate that Chameleon can support users when identifying structures in multi-scale molecular visualizations. 

TODO: comparison pentamer (identification solely by structure) and C- and N-terminal domain: same success rate, but lower certainty and higher task difficulty; indicates that structural changes are stronger 

TODO: secondary structures: shows limitations of color-only LOD: future work: combining Chameleon with alternative structural representation 

TODO: only noticed color changes for atomic levels, referred to protein domains by color; indicates that dynamic color mapping is not disturbing, yet provides a 
