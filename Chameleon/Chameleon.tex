	...
	\teaser{
		...
		\includegraphics[width=1\linewidth]{Figures/teaser_new}
				\caption{Interactive multi-scale visualization of HIV using ``Chameleon'' for dynamic color coding of protein and atom properties: 
					Zooming from an overview of the entire virus (a) to the capsid (b), the capsid interior (c), \textbf{TODO: which??} a single protein in the capsid (d), and its atomic structure (e). 
...
%	To distribute hues from the hue ring to the proteins, we sample the hues with respect to four parameters: 
	...
	However, in the initial level, have 46 distinct protein types distributed to five compartments. 
...
%	Assuming no spacing between compartments (i.e.\, $s=0$), this would result in only 32 distinct colors, which is far below the number of proteins in the HIV model. 
	The angular distance  $\alpha$ between protein type colors can therefore be below the optimal $d$: 
	\[
