...
\caption{The force based hue assignment mecanism. a) The groups are positioned with a naive approach non-iterative approach, b) the group are attracted towards their default hue value, until the system reached a state of equilibriu.}
...
Upon modulation of the group sizes we must also reposition the centroid group positions on that ring.
