...
%	In the example of Figure \ref{fig:zoomLevels}, we use a luminance range of 20 to distinguish the sub-elements. 
	...
	The task description was provided by the molecular biologist and illustrator David Goodsell and resembles a publicly available description of the HIV capsid at PDB-101 \cite{goodsell2016} (see supplemental material for full task description).
...
In the questionnaire, most users indicated that they noticed color changes (average response: 4 on a 5-point Likert scale), but the confusion caused by these color changes were rated fairly low (2 on average). 
...
Users were equally successful identifying a pentamer capsid protein and the protein domains. 
...
However, the users reported lower certainty but higher task difficulty for the identification of the domains.
