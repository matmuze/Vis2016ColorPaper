...
%	
	...
	A protein type is not visible if the ratio of visible to non visible elements becomes too low, based on an arbitrarily defined threshold $t_v$.
	[tbd elaborate on t sub v]
...
%	In the example of Figure \ref{fig:zoomLevels}, we use a luminance range of 20 to distinguish the sub-elements. 
	...
	\textbf{TODO: why did user 3 fail? Why was amino acid so hard to find?}
