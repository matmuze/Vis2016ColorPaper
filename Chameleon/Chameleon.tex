...
%	
	...
	While our method works for molecular data with 5 zoom levels, it may not be generalizable to all types of data.
	We also switch coloring type from a force-based layout (Section~\ref{sec:dynamic}) to hierarchical coloring (Section~\ref{sec:hierarchy}). 
